...
| [architecture/console-stack.md](architecture/console-stack.md) | The transferable console stack (Go + ConnectRPC + Vite/React/MUI behind gateway-auth): when to use it, layout to mirror, and the rules learned from real incidents — the guide for the next console |
